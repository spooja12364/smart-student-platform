    ...
    <div className="welcome-container">
      <div className="welcome-glass-panel">
        ...
        <div className="welcome-actions">
          ...
          <button className="btn btn-google" onClick={() => alert('Google Auth to be implemented')}>
            <svg viewBox="0 0 24 24" width="20" height="20" xmlns="http://www.w3.org/2000/svg" className="google-icon">
