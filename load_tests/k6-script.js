...
export default function () {
  // Use environment variable BASE_URL or fallback to local
...
// Function to generate the GitHub Step Summary Markdown
export function handleSummary(data) {
  ...
  let md = `## ⚡ Smart Student App Load Testing — Baseline (100 VUs x 1 Min)\n\n`;
  md += `100 Virtual Users running for 1 minute against the application.\n\n`;
...
// Minimal text summary for console output
function textSummary(data, options) {
    return "Load Test Completed. See k6-summary.md for the full markdown report.\n";
}
